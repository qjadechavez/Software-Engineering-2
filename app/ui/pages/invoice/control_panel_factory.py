...
class ControlPanelFactory:
    ...
    @staticmethod
    def create_search_control(search_input, search_callback, filter_callback=None, context="invoice"):
        """Create a search control panel with optional filter button
        ...
        Args:
            ...
            context: The context in which the control panel is used ("invoice" or "customer")
        ...
        search_input.setPlaceholderText("Search services..." if context == "invoice" else "Search customers...")
    ...
    def create_action_button(text, primary=True):
        ...
        button.setStyleSheet(StyleFactory.get_button_style(secondary=not primary))
        return button
    ...
    def create_section(title):
        ...
        label.setStyleSheet("color: white; font-size: 16px; font-weight: bold; margin: 10px 0px 5px 0px;")
        return label