...
class LoginPage(QtWidgets.QWidget):
    ...
    def create_brand_panel(self):
        ...
        self.logo_label.setGeometry(QtCore.QRect(170, 250, 300, 200))
        self.logo_label.setPixmap(QtGui.QPixmap("images/Miere1.png"))
        self.logo_label.setScaledContents(True)
        
        # Brand tagline
        self.tagline_label = QtWidgets.QLabel(self.left_panel)
        self.tagline_label.setGeometry(QtCore.QRect(120, 460, 400, 40))
